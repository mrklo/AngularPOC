...
export interface IFeeClient {
  get(): Observable<Fee[]>;
  postFee(fee: Fee): Observable<Fee>;
...
export class FeeClient implements IFeeClient {
  ...
  protected processPostFee(response: HttpResponseBase): Observable<Fee> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse ? response.body :
        (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    if (status === 201) {
      return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        result201 = Fee.fromJS(resultData201);
  ...
  getFee(id: number): Observable<Fee> {
    let url_ = this.baseUrl + "/api/Fee/{id}";
  ...
  protected processGetFee(response: HttpResponseBase): Observable<Fee> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse ? response.body :
        (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    if (status === 200) {
      return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        let result200: any = null;
        let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
        result200 = Fee.fromJS(resultData200);
        return _observableOf(result200);
      }));
    } else if (status !== 200 && status !== 204) {
      return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
...
export class PersonClient implements IPersonClient {
  ...
  protected processPostPerson(response: HttpResponseBase): Observable<Person> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse ? response.body :
        (<any>response).error instanceof Blob ? (<any>response).error : undefined;
